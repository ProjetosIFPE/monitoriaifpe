...
<body>
	...
	<form id="form1" action="cadastroAluno.do" method="post">
		<fieldset>
			...
			<input type="text" id="matricula" name="matricula" value="${requestScope.aluno.matricula }" class="${requestScope.CAMPOS_INVALIDOS['matricula']}" required="required" /> 
			<label id="email">E-mail</label> 
			<input type="email" name="email" id="email" value="${requestScope.aluno.email }"  class="${requestScope.CAMPOS_INVALIDOS['email']}" required="required" /> 
